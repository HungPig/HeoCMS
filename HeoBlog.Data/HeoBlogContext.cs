using HeoBlog.Core.Domain.Content;
...
{
    public class HeoBlogContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        public HeoBlogContext(DbContextOptions options) : base(options)
        {
